...
/**
 * Arquivo originalmente continha instruções DDL SQL e estava causando erros de compilação.
 * Preservo o DDL abaixo como comentário para referência. Se preferir, podemos
 * mover este conteúdo para um arquivo `.sql` no diretório `resources`.
 */
